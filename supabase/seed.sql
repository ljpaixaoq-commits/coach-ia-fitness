...
-- 1. PERFIS
INSERT INTO perfis (id, name, nickname, email, role, gender, age, height, current_weight, target_weight, body_fat_percentage, muscle_mass_kg, fitness_goal, gym_name, preferred_training_time, daily_water_target_ml, daily_calorie_target, daily_protein_target_g, daily_carb_target_g, daily_fat_target_g)
VALUES 
...
INSERT INTO treinos (id, profile_id, title, subtitle, category, day_of_week, estimated_duration_min, difficulty, ai_generated, is_active)
VALUES
...
INSERT INTO treino_exercicios (workout_id, name, muscle_group, sets, reps_target, default_weight_kg, rest_time_seconds, demo_instructions, order_index)
VALUES
...
INSERT INTO suplementos (id, profile_id, name, is_custom_blend, dosage, recipe_formula, recommended_time, current_stock_doses, min_stock_alert, unit, notes)
VALUES
...
INSERT INTO registro_lesoes (id, profile_id, body_part, pain_level, status, injury_date, symptoms, restricted_exercises, recommended_exercises, treatment_notes)
VALUES
...
-- 6. METAS
INSERT INTO metas (profile_id, title, category, current_value, target_value, unit, deadline, status)
VALUES
...
INSERT INTO coach_resumos_diarios (profile_id, summary_date, greeting, sleep_summary, weight_trend, workout_recommendation, energy_status, hydration_advice, supplement_reminder, goal_milestone_progress, full_markdown)
VALUES
